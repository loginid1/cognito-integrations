...
export default function SignupPage() {
    ...
    function renderView(view: SignupViewEnum) {
        if (view === SignupViewEnum.SignupPrompt) {
            return <SignupPrompt onComplete={onSignupPromptComplete} />
        } else if (view === SignupViewEnum.EmailConfirmation) {
            return <EmailConfirmation onComplete={onEmailConfirmationComplete} email={email} />
    ...
    function onSignupPromptComplete(email: string, next: string) {
        ...
        setEmail(email);
        if (next === "email") {
            setView(SignupViewEnum.EmailConfirmation);
        }
        else if (next === "passkey") {
