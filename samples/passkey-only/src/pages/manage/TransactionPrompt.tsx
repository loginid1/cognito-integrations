...
export function TransactionPrompt() {
    ...
    async function confirmPayTranstion() {
        ...
        try {
            ...
            if (username) {
                const result = LoginidService.client.confirmTransaction(username, JSON.stringify(payData))
    ...
    async function confirmSendTranstion() {
        ...
        try {
            ...
            if (username) {
                const result = LoginidService.client.confirmTransaction(username, JSON.stringify(confirmData))
                setTxRef((await result).txId)
            } else {
                setError("not authorized")
            }
